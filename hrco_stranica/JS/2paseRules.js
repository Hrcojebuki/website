...
const rulesContainer = document.getElementById('rules2p');
...
const evaluations2p = document.getElementsByClassName('evaluations')[0];
const dropdownMenu2p = document.getElementsByClassName('dropdown-menu')[0];

evaluations2p.addEventListener('click',()=>{
    dropdownMenu2p.classList.toggle('visible');
});
